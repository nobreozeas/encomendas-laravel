...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="{{ url()->previous() }}" class="btn btn-secondary"><i class="fa-solid fa-arrow-left me-2"></i>Voltar</a>
    </div>
            ...
            <div class="box_form">
                <form action="" id="form_agencia" class="row g-3">
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <button type="submit" id="add_agencia" class="btn btn-primary"><i
                                class="fa-solid fa-save me-2"></i>Salvar</button>
                    </div>
